...
class Family extends CI_Controller {
    ...
    public function index($offset = 0) {
        $data['title'] = "Family";
        $data['btn_add'] = anchor('family/add', 'Add new family');
        ...
        // load data
        $data['familys'] = $this->family_model->get_page_list($this->limit, $offset)->result();
    ...
    function add() {
        ...
        $data['form_action'] = site_url('family/save');
        $data['link_back'] = anchor('family/', 'Back', array('class' => 'back'));
    ...
    function edit($id) {
        ...
        $data['message'] = '';
        $data['form_action'] = site_url('family/update');
        $data['link_back'] = anchor('family/', 'Back');
