            ...
            <table border="1">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                        <?php echo anchor('educations/edit/' . $row->edu_id, 'Edit'); ?>
                        <?php echo anchor('educations/delete/' . $row->edu_id, 'Delete', array('onclick' => "return confirm('Are you sure want to delete this education?')")); ?>
                    </td>
                </tr>
                <?php
                    }
