            ...
            <table border="1">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                        <?php echo anchor('gaji/edit/' . $row->comp_id, 'Edit'); ?>
                        <?php echo anchor('gaji/delete/' . $row->comp_id, 'Delete', array('onclick' => "return confirm('Are you sure want to delete this gaji?')")); ?>
