...
$content_dalam = "";
$query = $this->db->query("SELECT * FROM employees_status ORDER BY sk_id ASC");


$x = 0;

foreach ($query->result() as $row) {
    $data = "<tr><td>" . $row->sk_id . "</td>
                <td>" . $row->sk_name . "</td>
                    </tr>";
...
header("Content-Disposition: attachment; filename=Employees_Status.xls");
